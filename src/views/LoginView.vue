...
async function handleLogin() {
  ...
  loading.value = true
  try {
    let res: { token: string; role: 'admin' | 'user'; username: string; name: string }
    try {
      ...
      const mockMap: Record<string, typeof res> = {
        'admin:admin': { token: 'mock-token-admin', role: 'admin', username: 'admin', name: '管理员' },
        'user:user':   { token: 'mock-token-user',  role: 'user',  username: 'user',  name: '普通用户' },
      }
