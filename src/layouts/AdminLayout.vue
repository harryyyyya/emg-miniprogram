    ...
    <aside class="sidebar" :class="{ collapsed: isCollapsed }">
      ...
      >
        <template v-for="item in menuItems" :key="item.path">
          <el-menu-item :index="'/admin/' + item.path">
...
const allMenu = [
  ...
  { path: 'errors', title: '错误分析', icon: 'Warning' },
  { path: 'reports', title: '报表管控', icon: 'Document' },
  { path: 'compute', title: '算力管理', icon: 'Monitor' },
  { path: 'forum', title: '社区管理', icon: 'ChatDotRound' },
  { path: 'knowledge', title: '知识库', icon: 'Reading' },
  { path: 'seed', title: '数据初始化', icon: 'SetUp' },
]

const menuItems = computed(() => allMenu)
