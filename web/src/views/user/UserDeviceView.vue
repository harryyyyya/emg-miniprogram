...
async function loadSessions() {
  ...
  try {
    ...
    sessions.value = all.filter((s: any) => !userId.value || s.user_id === userId.value || s.user_id === null)
  } catch {
    sessions.value = [
...
const defaultElectrodes: Electrode[] = [
...
function loadElectrodes(): Electrode[] {
...
const electrodes = reactive<Electrode[]>(loadElectrodes())
